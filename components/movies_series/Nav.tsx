  ...
  return (
    <div className='flex min-h-[10vh] fixed bg-[#000000cf] w-full md:flex-col md:items-center z-10'>
        ...
        <ul className="nav-links flex items-center w-[50%] justify-between text-white md:w-full md:px-[1rem] md:text-[0.8rem]">
            <li className='cursor-pointer'><Link href="/movies">Homepage</Link></li>
            <li className='cursor-pointer'><Link href="/series_table">Series</Link></li>
            <li className='cursor-pointer'><Link href="/movie_table">Movies</Link></li>
